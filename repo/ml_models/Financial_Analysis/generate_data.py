...
def process_json_file(file_path):
    ...
    found = False
    if os.path.exists('clean_data/yf_ref.csv'):
        yf_master_ref = open('clean_data/yf_ref.csv', 'r')
    ...
    if not found:
        ...
        new_date_obj = date_obj + timedelta(days=252)  # Assuming a year has 365 days
        ...
        if not stock_data.empty:
            ...
            with open('clean_data/yf_ref.csv', 'a', newline='') as saveTarget:
